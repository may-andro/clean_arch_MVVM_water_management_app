...
import com.mayandro.waterio.databinding.ActivityAuthBinding
...
class AuthActivity : BaseActivity<ActivityAuthBinding, AuthActivityViewModel>(),
            ...
            .addOnCompleteListener(
                ...
                if (it.isSuccessful) {
                    ...
                    if (it.exception is FirebaseAuthInvalidCredentialsException) {
                        ...
                        showSnackBarMessage(it.exception?.message?: "Verification Failed")
                    } else {
                        showSnackBarMessage("Verification Failed")
                    }
                }
            }
    }
    ...
    override fun goToGoalActivity() {
        startActivity(GoalsActivity.getIntent(this))
        finish()
    }
